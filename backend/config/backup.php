    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                // Only storage_path() (uploads that land on the local disk in
                // dev, logs) — app code lives in git and rider/driver uploads
                // live on the S3/R2 disks already, so backing up the whole
                // codebase here would just be dead weight.
                'include' => [
                    storage_path(),
                ],
