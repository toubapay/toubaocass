...
// Each app (rider_flutter, driver_flutter) is a separate install with its
// own bundle/package id (com.intercity.rider_flutter /
// com.intercity.driver_flutter), so the OS-level secure storage (Keychain /
// Keystore) already isolates them from each other — both apps can safely
// use the same storage key without colliding.
const _tokenKey = 'intercity_flutter_token';
