...
/// Driver summary as attached to a Trip/AnandoRide/DemLeguiTrip. The
/// location/lastSeenAt fields are only populated by endpoints that track a
/// live position (currently Dem Légui); callers that don't get them back
/// from the API just see null, same as before this class absorbed the old
/// separate DemLeguiTripDriver shape.
class TripDriver {
  final int id;
  final String? name;
  final String phone;
