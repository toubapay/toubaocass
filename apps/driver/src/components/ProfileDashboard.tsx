    ...
    <View style={styles.container}>
      <View style={styles.grid}>
        ...
        <StatTile
          ...
          onPress={() => navigation.navigate('TripsTab', { screen: 'Anando', params: { initialTab: 'mine' } })}
        />
        ...
        <TripRow
          ...
          onPress={() =>
            ...
            navigation.navigate('TripsTab', { screen: 'TripDetail', params: { tripId: stats.active_booking.id } })
          }
        />
        <TripRow
          icon="🕓"
          ...
          onPress={() =>
            stats.last_trip &&
            navigation.navigate('TripsTab', { screen: 'TripDetail', params: { tripId: stats.last_trip.id } })
          }
        />
