...
const styles = StyleSheet.create({
  ...
  gpsButtonText: { color: colors.accent, fontWeight: '700', fontSize: 13 },
  clearLink: { color: colors.textMuted, fontSize: 13 },
  ...
  calloutDistance: { fontSize: 12, color: colors.accent, fontWeight: '700', marginTop: 2 },
