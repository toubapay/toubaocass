...
const styles = StyleSheet.create({
  ...
  warning: { fontSize: 12, color: colors.danger, marginTop: -spacing.sm, marginBottom: spacing.md },
  error: { fontSize: 12, color: colors.danger, marginBottom: spacing.sm },
  fare: { fontSize: 15, fontWeight: '700', color: colors.primary, marginBottom: spacing.md },
