...
android {
    namespace = "com.intercity.driver_flutter"
    ...
    defaultConfig {
        applicationId = "com.intercity.driver_flutter"
        minSdk = flutter.minSdkVersion
        targetSdk = flutter.targetSdkVersion
        versionCode = flutter.versionCode
        versionName = flutter.versionName
        // Pass `-PmapsApiKey=...` or set `mapsApiKey=...` in
        // android/local.properties (gitignored) before building for a device.
