...
class DemLeguiTripDriver {
  ...
  factory DemLeguiTripDriver.fromJson(Map<String, dynamic> json) => DemLeguiTripDriver(
        id: json['id'] as int,
        name: json['name'] as String?,
        phone: json['phone'] as String,
        rating: (json['rating'] as num?)?.toDouble() ?? 0,
...
class DemLeguiTrip {
  final int id;
  final DemLeguiTripDriver driver;
  final Car? car;
  final City? destinationCity;
  final int totalSeats;
  final int availableSeats;
  ...
  factory DemLeguiTrip.fromJson(Map<String, dynamic> json) => DemLeguiTrip(
        id: json['id'] as int,
        driver: DemLeguiTripDriver.fromJson(json['driver'] as Map<String, dynamic>),
        car: json['car'] == null ? null : Car.fromJson(json['car'] as Map<String, dynamic>),
        destinationCity:
            json['destination_city'] == null ? null : City.fromJson(json['destination_city'] as Map<String, dynamic>),
        totalSeats: json['total_seats'] as int,
