    ...
    getFirebaseMessaging()
      .then((messaging) => {
        ...
        unsubscribe = onMessage(messaging, (payload) => {
          // Let interested components (delivery badge, Dem Légui requests,
          // …) refetch immediately regardless of whether a native
          // notification is actually shown below — a driver who denied the
          // permission prompt should still see live-updating lists while
          // the tab is open.
